defmodule Advent2022.Day6 do
  defmodule Part1 do
    ...
    def possible_markers(str) when is_list(str) do
      possible_markers(str, [])
    end

    defp possible_markers(str = [a, b, c, d | _], acum) do
      possible_markers(tl(str), [[a, b, c, d] | acum])
    end

    defp possible_markers(_, acum), do: Enum.reverse(acum)
  end
  ...
  defmodule Part2 do
    ...
    defp possible_markers(str = [_ | tail], acum) when length(str) >= 14 do
      possible_marker = Enum.take(str, 14)
      possible_markers(tail, [possible_marker | acum])
    end
